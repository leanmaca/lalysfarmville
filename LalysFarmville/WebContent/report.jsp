...
<% ArrayList studentListCompany = (ArrayList)session.getAttribute("studentListCompany");%>
<%if (login == null){
...
<body>
	...
	<table>
		...
		<%if(check != null){ %>
    	<%for (int i = 0 ; i < studentListCompany.size() ; i++) {%>
    	<%StudentBean studentBean2 = (StudentBean)studentList.get(i); %>
		<tr>
			
			<td><%= studentBean2.getStudentFName() %> <%= studentBean2.getStudentMName() %> <%= studentBean2.getStudentLName() %></td>
			<td><%= studentBean2.getCourse() %></td>
			<td><%= studentBean2.getCompany() %></td>
			<td><%= studentBean2.getSalaryMin() %> - <%= studentBean2.getSalaryMax() %></td>
