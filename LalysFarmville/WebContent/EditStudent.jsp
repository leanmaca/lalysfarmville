...
<div class=function-area>
	...
	<div class="columns" id="register_content">
		<form action="<%=request.getContextPath()%>/EditServlet"
			...
			<br>
			<div class="item">
				<span><label><b>Student Classification:</b></label> <select name="studentclassification1" id="studentclassification" value="<%=student.getStudentClassification()%>" required>
			...
			<br>
			<div class="item">
			<label><b>Other student classification:</b></label> <input
				type="text" id="studentclassification2" name="studentclassification2" placeholder="Other student classifications" disabled> <br>
				</div>
			<br>
			<script>
			function classificationothers() {
				var classification = document.getElementById('studentclassification');
				var selectedValue = classification.options[classification.selectedIndex].value;
				if (selectedValue == "Others") {
					document.getElementById('studentclassification2').disabled = false;
					document.getElementById('studentclassification2').required = true;
				} else {
					document.getElementById('studentclassification2').disabled = true;
					document.getElementById('studentclassification2').value = null;
					document.getElementById('studentclassification2').required = false;
					
				}
			}
			
			document.getElementById('studentclassification').addEventListener("click", classificationothers);
			</script>
			...
			<option value="<%=student.getScheduleId() %>"><%=student.getScheduleId() %></option>
			<%
			try{
				Class.forName("com.mysql.jdbc.Driver");
					Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/lalysfarmville", "root",
